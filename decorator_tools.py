...
def arg_decorator[** P, ** Q, T, U](func: Callable[Concatenate[Callable[Q, U], P], T]) -> Callable[
    P, Callable[[Callable[Q, U]], T]]:
...
@arg_decorator
def map_first_arg_decorator[S, T, U, ** P](f: Callable[Concatenate[T, P], U], m: Callable[[S], T]) -> Callable[
    Concatenate[S, P], U]:
